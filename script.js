...
heroSection.addEventListener('mousemove', (e) => {
    ...
    stars.forEach(star => {
        ...
        if (distance < 15) {
            ...
            star.style.opacity = Math.min(1, parseFloat(star.style.opacity) + force * 0.5);
        } else if (distance < 25) {
...
// Console message
console.log('%c台中一中學生未入黨', 'font-size: 24px; font-weight: bold; color: #000;');
console.log('%c為學生發聲 · 為權利奮鬥', 'font-size: 14px; color: #666;');
